...
To host this project live for free, use the following separated architecture:
...
- Open `frontend/script.js` and replace `http://127.0.0.1:8000/generate-test` with your live Render URL.

3. **Deploy Frontend on Vercel (Vercel.com)**

- Connect the repo to Vercel.
- Set the root directory to `frontend`.
- Deploy instantly for a lightning-fast UI.
...
Feel free to check the [issues page](https://www.google.com/search?q=https://github.com/Shannaseem/AI-Test-Generator/issues).

---

_Disclaimer: AI models can make mistakes. It is highly advised to review and verify the generated exam paper before distributing it to students._
